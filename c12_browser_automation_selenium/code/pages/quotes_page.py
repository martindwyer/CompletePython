...
from course_contents.c12_browser_automation_selenium.code.locators.quotes_page_locators import QuotesPageLocators
from course_contents.c12_browser_automation_selenium.code.parsers.quote import QuoteParser
